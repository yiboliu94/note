...
I think 'one 7X7 filter equals to three 3X3 filters' is because of the padding=valid. 7x7 filter convtional will lose 6 pixel width in output demision. The 3X3 filter will lose 2 pixel width in output demision, hence we use 3X3 fileter to do convolution three times will lose 3X2=6 pixels in the width of output feature map.  That's the 'Equivalent'.\

The benefit of replace big filter with multiple small fiters:\
...
A output piexel needs  K^2=49 Mul operations. But with 3 times of small filter convolution, A output piexels needs 3XK'^2=3X3^2=27 Muloperations.\
